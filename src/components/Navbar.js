        ...
        return (
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                <div className="container-fluid">
                    <a lassName="navbar-brand" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample" >Big eCom</a>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul className="navbar-nav  mb-2 mb-lg-0">
                            <li className="nav-item"><a className="nav-link"  type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">Login</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
